...
import com.techtravelcoder.dailynote.room.dao.BaseNoteDao
import com.techtravelcoder.dailynote.room.dao.CommonDao
import com.techtravelcoder.dailynote.room.dao.LabelDao
...
abstract class NotallyDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * allowMainThreadQueries() is only used in [com.techtravelcoder.dailynote.ReminderReceiver.onReceive]
