package com.techtravelcoder.dailynote.miscellaneous
...
import com.techtravelcoder.dailynote.BuildConfig
import com.techtravelcoder.dailynote.R
import com.techtravelcoder.dailynote.databinding.LabelBinding
...
object Operations {
    ...
    const val extraCharSequence = "com.techtravelcoder.dailynote.extra.charSequence"
    ...
    fun extractColor(color: Color, context: Context): Int {
        val id = when (color) {
            ...
            Color.NC1 -> R.color.NC1
            Color.NC2 -> R.color.NC2
            Color.NC3 -> R.color.NC3
            Color.NC4 -> R.color.NC4
            Color.NC5 -> R.color.NC5
        }
