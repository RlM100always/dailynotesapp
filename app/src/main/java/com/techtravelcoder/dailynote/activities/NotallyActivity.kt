...
import com.techtravelcoder.dailynote.databinding.ActivityNotallyBinding
import com.techtravelcoder.dailynote.databinding.DialogProgressBinding
import com.techtravelcoder.dailynote.databinding.DialogReminderBinding
...
import com.techtravelcoder.dailynote.preferences.TextSize
import com.techtravelcoder.dailynote.recyclerview.adapter.AudioAdapter
import com.techtravelcoder.dailynote.recyclerview.adapter.ErrorAdapter
import com.techtravelcoder.dailynote.recyclerview.adapter.PreviewImageAdapter
import com.techtravelcoder.dailynote.room.Audio
import com.techtravelcoder.dailynote.room.Folder
import com.techtravelcoder.dailynote.room.Frequency
...
import com.techtravelcoder.dailynote.viewmodels.NotallyModel
...
abstract class NotallyActivity(private val type: Type) : AppCompatActivity() {
    ...
    private fun delete() {
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("Yes") { _, _ ->  model.folder = Folder.DELETED
                finish() }
    ...
    private fun restore() {
        MaterialAlertDialogBuilder(this)
            ...
            .setMessage("Are you sure to restore this notes ?")
    ...
    private fun archive() {
        MaterialAlertDialogBuilder(this)
            ...
            .setMessage("Are you sure to archive this notes ?")
            .setPositiveButton("Yes") { _, _ ->
                lifecycleScope.launch {
    ...
    private fun deleteForever() {
        MaterialAlertDialogBuilder(this)
            .setTitle("Delete Notes")
            .setMessage("Are you sure to delete this notes forever ?")
            .setPositiveButton("Yes") { _, _ ->
                lifecycleScope.launch {
    ...
    private fun setupToolbar() {
        ...
        val pin = menu.add(R.string.pin).apply {
        ...
        menu.add(R.string.labels).apply {
        ...
        menu.add(R.string.add_images).apply {
            setIcon(R.drawable.add_images)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            menu.add(R.string.record_audio).apply {
                setIcon(R.drawable.record_audio)
                setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS)
                setOnMenuItemClickListener {
        ...
        menu.add(R.string.set_reminder).apply {
        ...
        when (model.folder) {
            Folder.NOTES -> {
                ...
                menu.add(R.string.archive).apply {
            ...
            Folder.DELETED -> {
                menu.add(R.string.restore).apply {
                ...
                menu.add(R.string.delete_forever).apply {
                    setIcon(R.drawable.delete)
                    setOnMenuItemClickListener {
                        deleteForever()
                        true
            ...
            Folder.ARCHIVED -> {
                ...
                menu.add(R.string.unarchive).apply {
                    setIcon(R.drawable.unarchive)
                    setOnMenuItemClickListener {
                        restore()
                        true
                    }
